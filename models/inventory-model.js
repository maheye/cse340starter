...
/* ***************************
 *  Get vehicles information by inventory_id
 * ************************** */
...
* *************************** */
async function processAddInventory(inv_make, inv_model, inv_year, inv_description, inv_image, inv_thumbnail, inv_price, inv_miles, inv_color, classification_id){
  try {
...
module.exports = {getClassifications, getInventoryByClassificationId, getInventoryByInventoryId, processAddClassification, processAddInventory, checkExistingClassification, updateInventory, deleteInventoryItem};
